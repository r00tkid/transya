...
urlpatterns = [
    ...
    url(r'^translate/save/$', SaveTranslateView.as_view(), name="SaveTranslatePage"),
    url(r'^translate/show/$', ShowTranslateView.as_view(), name="ShowTranslatePage"),
]
